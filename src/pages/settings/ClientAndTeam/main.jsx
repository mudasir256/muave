...
const MainComponent = () => {
    ...
    return (
        <div>
            ...
            <Modal isOpen={addMemberModalOpen} onClose={closeAddMemberModal} title={"Add team member"} description={"To invite a member of your team - you need to send them a referral link."}>
            ...
            <Modal isOpen={addClientAccessModalOpen} onClose={closeClientAccessMemberModal} title={"Add client access"} description={"Here you can specify the client's access level"}>
                <div className='flex w-full justify-between'>
                    <div id="modalScroll" className='w-full' style={{
                        paddingRight: '20px',
                        maxHeight: '450px',
            ...
            <Modal isOpen={addTeamAccessModalOpen} onClose={closeTeamAccessMemberModal} title={"Add Team access"} description={"Here you can specify the team's access level"}>
                <div className='flex w-full justify-between'>
                    <div id="modalScroll" className='w-full' style={{
                        paddingRight: '20px',
                        maxHeight: '450px',
